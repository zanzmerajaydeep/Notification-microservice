...
public class HospitalController {
	...
	public Hospital getPatientByConatctNo(@RequestParam  String contactNo)
	{
		return hospitalServiceImlp.getPatientByContactNo(contactNo); 
	}
	...
	@PostMapping("/callSMSServiceByContactNo")
